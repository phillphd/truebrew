  ...
  return (
    <>
      ...
      <section style={{ background: "#1a1510" }}>
        <div className="max-w-[1440px] mx-auto px-12 py-20 flex items-center gap-12">
          {/* Left */}
          <div className="flex flex-col gap-8 flex-1">
            ...
            <p className="text-xl leading-relaxed" style={{ color: "#A89888" }}>
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                href="/our-work"
                className="px-6 py-3 rounded font-semibold text-sm border transition-colors hover:bg-white/5"
          ...
          <div className="flex-1 relative h-[500px] rounded-xl overflow-hidden">
            <Image
              src="https://images.unsplash.com/photo-1628143639143-29e727a807fc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080"
      ...
      <section id="services" style={{ background: "#FBF7F2" }}>
        <div className="max-w-[1440px] mx-auto px-[120px] py-20 flex flex-col gap-12">
          {/* Header */}
      ...
      <section id="about" style={{ background: "#1a1510" }}>
        <div className="max-w-[1440px] mx-auto px-[120px] py-20 flex items-center gap-12">
          {/* Left */}
          <div className="flex flex-col gap-6 flex-1">
            ...
            <h2
              className="text-4xl font-bold leading-[1.1]"
              style={{ color: "#F5E6D3" }}
            >
          ...
          {/* Right image */}
          <div className="flex-1 relative h-[420px] rounded-xl overflow-hidden">
            <Image
              src="https://images.unsplash.com/photo-1726931535415-edbc43d42c28?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080"
      ...
      <section style={{ background: "#FBF7F2" }}>
        <div className="max-w-[1440px] mx-auto px-[120px] py-20 flex flex-col items-center gap-10 text-center">
          <h2
            className="text-4xl font-bold"
            style={{ color: "#1a1510" }}
          >
